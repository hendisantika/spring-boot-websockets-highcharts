function Diagram(selector, seriesNames, yAxisMax) {
    var that = this;
...
var client = Stomp.over(new SockJS('/demo'));
...
client.connect({}, function (frame) {
    client.subscribe("/performance", function (message) {
        var performance = JSON.parse(message.body);
